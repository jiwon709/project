  ...
  <body class="u-body"><header class="u-align-center-xs u-border-1 u-border-grey-25 u-clearfix u-header u-header" id="sec-7399"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        ...
        <nav class="u-align-left u-menu u-menu-dropdown u-nav-spacing-25 u-offcanvas u-menu-1">
          ...
          <div class="u-custom-menu u-nav-container">
            <ul class="u-custom-font u-nav u-unstyled u-nav-1"><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="HOME.jsp" style="padding: 10px 20px;">HOME</a>
...
<!--       			<th>최종수정일</th> -->
      	...
      	<c:forEach items="${requestScope.list}" var="vo">
      		<tr>											
      			<th><a href="<c:url value='/ss_nr/thenr?PRDCT_NM=${vo.PRDCT_NM}'/>">${vo.PRDCT_NM}</a></th>
<%--       			<th>${vo.IFTKN_ATNT_MATR_CN}</th> --%>
<%--       			<th>${vo.PRIMARY_FNCLTY}</th> --%>
<%--       			<th>${vo.DAY_INTK_LOWLIMIT}</th> --%>
<%--       			<th>${vo.DAY_INTK_HIGHLIMIT}</th> --%>
      			<th>${vo.INTK_UNIT}</th>
<%--       			<th>${vo.INTK_MEMO}</th> --%>
      			<th>${vo.SKLL_IX_IRDNT_RAWMTRL}</th>
<%--       			<th>${vo.CRET_DTM}</th> --%>
<%--       			<th>${vo.LAST_UPDT_DTM}</th> --%>
      		</tr>
      	</c:forEach>
      </table>
